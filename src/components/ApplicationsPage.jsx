...
const demoApps = [
    { scheme:"Student Education Support (NMMS)", status:"Ready to apply", progress:75, url:"https://scholarships.gov.in/" },
  { scheme:"General Housing Assistance (PMAY-G)", status:"Documents pending", progress:50, url:"https://pmayg.nic.in/" },
  { scheme:"Lakshmir Bhandar", status:"Under review", progress:60, url:"https://socialsecurity.wb.gov.in/" },
];
